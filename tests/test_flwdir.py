import pytest
from hydromt_sfincs.workflows.flwdir import basin_mask, river_centerline_from_hydrography, river_source_points
...
def test_river_source_points(hydrography, data_catalog):
    ...
    with pytest.raises(ValueError, match="src_type must be either"):
        gdf_src = river_source_points(gdf_riv=gdf_riv, gdf_mask=gdf_mask, src_type='wrong')
