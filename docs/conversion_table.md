...
| `SfincsModel.setup_dep()` | `SfincsModel.elevation.create()` | datasets_dep → elevation_sets |
...
| `SfincsModel.setup_subgrid()` | `SfincsModel.subgrid.create()` | datasets_dep → elevation_sets, datasets_rgh → roughness_sets, datasets_riv → river_sets, nr_levels → nlevels |
...
| `SfincsModel.setup_manning_roughness()` | `SfincsModel.roughness.create()` | datasets_rgh → roughness_sets |
